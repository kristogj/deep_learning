...
from utils import get_ids, get_anns, get_pretrained_embeddings
...
embedding_dim = 50  # MUST MATCH PRE-TRAINED DIMENSION
hidden_dim = 512
vocab_size = len(vocab)
pretrained_embeddings = get_pretrained_embeddings("./glove.6B/glove.6B.50d.txt", vocab)
model = Baseline(embedding_dim, hidden_dim, vocab_size, vanilla=False, embeddings=pretrained_embeddings)
